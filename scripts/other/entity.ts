...
export class Item { constructor(public readonly id: string, public readonly name: string, public readonly imgSrc: string, public count: number) {} }
...
export class Recipe {
    constructor(public result: SwordItem | RepairPaperItem, public materials: Item[]) {}
}
