...
import { Color, MoneyItem, PieceItem, SwordItem, UnknownItem } from "../other/entity.js";
...
export class MakingScreen extends Screen {
    ...
    makeRepairPaperPage(recipes) {
        return recipes.map(recipe => this.makeGroupArticle(this.makeMaterialSection(recipe.materials), this.makeResultSection(recipe.result), "blue", !Game.inventoryManager.hasItems(recipe.materials), () => onClickMakingButton(recipe)));
    }
